...
const CredentialSubmission = ({ onClose, listing }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white sm:rounded-lg shadow-2xl w-full max-w-lg max-h-[80vh] overflow-auto sm:h-auto flex flex-col">
        {/* Header */}
