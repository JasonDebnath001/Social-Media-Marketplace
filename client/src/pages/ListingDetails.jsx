...
const ListingDetails = () => {
  ...
  // derive listing from props/state instead of setting local state inside an effect
  ...
  return listing ? (
    <div className="mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex items-start max-md:flex-col gap-16">
        <div className="flex-1 max-md:w-full1">
          {/* Top section */}
          ...
          {images?.length > 0 && (
            <div className="bg-white rounded-xl border border-gray-200 mb-5 overflow-hidden">
              ...
              <div className="relative w-full aspect-video overflow-hidden">
                ...
                >
                  <ChevronFirstIcon className="w-5 h-5 text-gray-700" />
                </button>
                <button
                  onClick={nextSlide}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 text-sm">
              ...
              <div>
                ...
                <p className="flex items-center font-medium">
                  <MapPin className="size-4 mr-1 text-400" /> {listing.country}
                </p>
              </div>
              <div>
        ...
        <div className="bg-white min-w-full md:min-w-[370px] rounded-xl border border-gray-200 p-5 max-md:mb-10">
          ...
          {listing.isCredentialChanged && (
            <button
              ...
              className="w-full bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 transition text-sm font-medium flex items-center justify-center gap-2 mt-4"
            >
      ...
      <div className="bg-white border-t border-gray-200 p-4 text-center mt-28">
        <p className="text-sm text-gray-500">
          &copy; 2025 <span className="text-indigo-600">Aritra Debnath</span>.
          All Rights Reserved.
        </p>
      </div>
    </div>
